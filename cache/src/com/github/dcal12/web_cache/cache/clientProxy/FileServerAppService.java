...
public class FileServerAppService
    ...
    /**
     * @param features A list of {@link javax.xml.ws.WebServiceFeature} to configure on the clientProxy.  Supported features not in the <code>features</code> parameter will have their default values.
     * @return returns FileServer
     */
    @WebEndpoint(name = "FileServerAppPort")
