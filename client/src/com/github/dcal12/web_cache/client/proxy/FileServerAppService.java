 ...
 * 
 */
@WebServiceClient(name = "FileServerAppService", targetNamespace = "http://server.web_cache.dcal12.github.com/", wsdlLocation = "http://localhost:8080/app/FileServerAppService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/app/FileServerAppService?wsdl");
