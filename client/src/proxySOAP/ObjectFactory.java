 ...
 * generated in the proxySOAP package. 
...
public class ObjectFactory {
    ...
    private final static QName _GreetResponse_QNAME = new QName("http://app/", "greetResponse");
    private final static QName _Greet_QNAME = new QName("http://app/", "greet");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: proxySOAP
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://app/", name = "greetResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://app/", name = "greet")
